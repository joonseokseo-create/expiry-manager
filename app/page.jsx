...
/* ---------------------------
  ...
  :root{
    --font-sans: "Pretendard Variable","Pretendard", system-ui, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Arial, sans-serif;
  }
  ...
  *{
  ...
  @media (max-width:768px){
    ...
    .user-info{ font-size:11px; max-width:320px; }
